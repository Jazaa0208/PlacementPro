...
export const getPracticeQuestions = (topic) =>
  API.get(`/aptitude/topic/${topic}/practice`);
export const getVideo = (topic) =>
  API.get(`/aptitude/topic/${topic}/video`);
export const completePractice = (topic) =>
  API.post(`/aptitude/topic/${topic}/complete-practice`);
export const checkAnswer = (topic, payload) =>
  API.post(`/aptitude/topic/${topic}/check-answer`, payload);
export const getTestQuestions = (topic) =>
  API.get(`/aptitude/topic/${topic}/test`);
